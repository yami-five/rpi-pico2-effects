...
void rotate(float *x, float *y, float *z, TransformMatrix * TransformMatrix);
void translate(float *x, float *y, float *z, TransformMatrix * TransformMatrix);
void scale(float *x, float *y, float *z, TransformMatrix * TransformMatrix);
